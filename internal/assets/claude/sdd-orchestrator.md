...
| `sdd-design` | Proposal (required), Spec (optional) | Yes (`design`) |
| `sdd-tasks` | Proposal + Spec + Design (required) | Yes (`tasks`) |
| `sdd-apply` | Proposal + Spec + Design + Tasks | Yes (`apply-progress`) |
| `sdd-verify` | Proposal + Spec + Design + Tasks | Yes (`verify-report`) |
